...
[];Logos.ReferenceTagging.lbsTargetSite="biblia";Logos.ReferenceTagging.lbsCssOverride=!0;Logos.ReferenceTagging.tag()}$(function(){FastClick.attach(document.body)});var l=angular.module("msmApp",["ngRoute","ngSanitize","angulartics","angulartics.google.analytics"]);l.config(function(a,b){a.when("/",{templateUrl:"html/home.html"}).when("/about",{templateUrl:"html/about.html"}).when("/events",{templateUrl:"html/events.html"}).when("/weekly",{templateUrl:"html/weekly.html"}).when("/initiative",{templateUrl:"html/initiative.html"}).when("/upcoming",
{templateUrl:"html/upcoming.html"}).when("/news",{templateUrl:"html/news.html"}).when("/podcasts",{controller:"podcastsController",templateUrl:"html/podcasts.html"}).when("/contact",{templateUrl:"html/contact.html"}).when("/thankyou",{templateUrl:"html/thankyou.html"}).when("/blog",{templateUrl:"html/blog.html"}).otherwise({redirectTo:"/"})});l.service("selectedService",function(){var a,b={};return{getSelected:function(){return a},setSelected:function(c,d,e){d&&e&&(b[d]||(b[d]=""),b[d]=e);a=c;angular.forEach(b,
function(a,c){})}}});l.controller("TopBar",function(a,b,c){a.items=[{name:"Home",url:"#/"},{name:"About Us",url:"#/about"},{name:"Ministries",url:"#/events"},{name:"News/Updates",url:"#/news"},{name:"Podcasts",url:"#/podcasts"},{name:"Contact",url:"#/contact"}];a.selected=a.items[0];a.select=function(c){"Home"===c.name?window.open("#","_self"):"News/Updates"===c.name?window.open("#/news","_self"):b.reload();a.selected=c;$(".top-bar").removeClass("expanded");f()};var d=!1,e=$("body");e.addClass("slide-from-side-closed");
a.toggleSlide=function(){f()};window.addEventListener("orientationchange",function(){!0===d&&f()});var f=function(){!1===d?(e.removeClass("slide-from-side-closed"),e.addClass("slide-from-side-open")):(e.removeClass("slide-from-side-open"),e.addClass("slide-from-side-closed"));d=!d}});l.controller("SlidesController",function(){console.log("SlidesController");$(function(){console.log("run after doc load")})});l.controller("JoyrideController",function(a){a.tour=function(){console.log("joyride controller working!")}});
l.controller("InitializeController",function(){$(document).foundation()});l.controller("podcastsController",function(a){$("audio").mediaelementplayer();a.playThis=function(a){var c=new MediaElementPlayer("#podcastPlayer");c.pause();c.setSrc(a);c.play()}});l.controller("HomeController",["$scope","httpService",function(a,b){var c={};a.nextEvent;b.getLabeledPostRecursive("$$Upcoming Ministry Events").then(function(d,e,f,b){var n=new Date;angular.forEach(d.items,function(a,e){var d=a.title.indexOf(":"),
h=a.title.substr(0,d),d=a.title.substr(d+1,a.title.length),h=r(h),f=h.getDate(),b=t(h.getDay()),k=s(h.getMonth()),q=h.getFullYear();a.title=d;a.date=h;a.dateText=b+", "+k+" "+f;n>h||q&&(c[h]||(c[h]=a))});var q;angular.forEach(c,function(a,c){q?q>a.date&&(q=a.date):q=a.date});a.nextEvent=c[q]}).then(function(){b.resetRecursiveGet();a.currentNews;var c=[],e={0:{title:"Current News/Updates",data:{}}};b.getLabeledPostRecursive("$News/Updates").then(function(f,b,n,q){var g=new Date;angular.forEach(f.items,
function(a,e){var h=a.title.indexOf(":"),b=a.title.substr(0,h),h=a.title.substr(h+1,a.title.length),b=r(b),f=b.getDate(),n=t(b.getDay()),k=s(b.getMonth());b.getFullYear();a.title=h;a.date=b;a.dateText="For "+n+", "+k+" "+f;if(0<=a.labels.indexOf("Sunday School Update")||0<=a.labels.indexOf("Bible Study Update"))h=new Date(a.date.getTime()-6048E5),a.date=h;h=new Date(a.date.getTime()+6912E5);b=new Date(a.date.getTime()+864E5);a.date>g||g>h||(0<=a.labels.indexOf("Sunday School Update")||0<=a.labels.indexOf("Bible Study Update")?
g>b&&c.push(a):c.push(a))});e[0].data=c;angular.forEach(e,function(a,c){a.data.sort(v);a.data.reverse()});a.currentNews=e[0].data;angular.element(document).foundation("orbit",{animation:"slide",timer_speed:5E3,pause_on_hover:!1,resume_on_mouseout:!1,animation_speed:250,stack_on_small:!1,navigation_arrows:!1,slide_number:!1,bullets:!0,timer:!0,variable_height:!0,container_class:"orbit-container"});f=angular.element(".orbit-container img").first().height()+20;angular.element(".orbit-slides-container").css({"min-height":f});
m()})})}]);l.controller("AboutController",["$scope","httpService",function(a,b){var c,d,e,f,k,n;b.getLabeledPost("$About Us").success(function(b,g,l,p){if(b.items[0]&&b.items[1]){g=b.items[0].labels[0];if("$"===g.substr(0,1))a.title=g.substr(1,g.length);else return a.title="Page Error","";"Our Youth Pastor"===b.items[0].title?(n=b.items[0],k=b.items[1]):(n=b.items[1],k=b.items[0]);c=k.title;d=k.content;e=n.title;f=n.content;a.getMissionStatement();m()}else a.title="Page Error"}).error(function(a,
c,b,e){});a.getMissionStatement=function(){a.subtitle=c;a.content=d;a.isMissionStatement=!0;a.isOurYouthPastor=!1;m()};a.getOurYouthPastor=function(){a.subtitle=e;a.content=f;a.isMissionStatement=!1;a.isOurYouthPastor=!0;m()}}]);l.controller("WeeklyController",["$scope","httpService",function(a,b){var c,d,e,f,k,n;b.getLabeledPost("$$Weekly Ministries").success(function(b,g,l,p){if(b.items[0]&&b.items[1]){if("$$"===b.items[0].labels[0].substr(0,2))a.title="Weekly Ministries";else return a.title="Page Error",
"";"Weekly Bible Study"===b.items[0].title?(k=b.items[0],n=b.items[1]):(k=b.items[1],n=b.items[0]);e=n.title;f=n.content;c=k.title;d=k.content;a.getBibleStudyTemplate();m()}else a.title="Page Error"}).error(function(a,b,c,e){});a.getBibleStudyTemplate=function(){a.image="img/Revelation_s.png";a.subtitle=c;a.content=d;a.mapLink="https://maps.google.com/maps?q=1411+kennoway+park,+Spring+TX,+77379&hl=en&sll=31.168934,-100.076842&sspn=10.237092,8.76709&hnear=1411+Kennoway+Park+Dr,+Spring,+Texas+77379&t=m&z=16";
